...
> {
  ...
  /**
   * Encodes the given value into the provided buffer according to the MessagePack format.
   *
   * @param value - The value to be encoded. This can be of any type, but the implementation should handle specific types as needed.
  ...
  /**
   * Decodes a value from the provided DataView starting at the specified offset.
   * The method should read the necessary bytes from the DataView, reconstruct
   * the original value, and return it.
   *
   * @param decoderBuffer - The buffer containing the encoded data to be decoded.
